...
//거래처 폼
	...
	if(isset($_REQUEST['no']) && $_REQUEST['no'] != null) {
		...
		$conn->DBI(); //DB 접속
		$query = "SELECT * FROM wine_employee WHERE idx = $no";
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				...
				<div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="name" name="name" minlength="2" type="text" required <?if(isset($no)){echo 'value='.$result['emp_name'];}?>>
                    </div>
				</div>
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <input class=" form-control" id="job" name="job" minlength="2" type="text"
					  <?if(isset($no)){echo 'value='.$result['emp_job'];}?>>
                    </div>
                    <label for="dept" class="control-label col-lg-2">부서</label>
                    <div class="col-lg-4">
                      <input class=" form-control" id="dept" name="dept" minlength="2" type="text"
					  <?if(isset($no)){echo 'value='.$result['emp_dept'];}?>>
                    </div>
				</div>
<?
if(isset($no)){
...
?>
				...
				<div class="form-group">
                    ...
                    <div class="col-lg-10">
					  ...
					  <?if(isset($no)){echo 'value='.$result['emp_mail'];}?>>
                    </div>
				</div>
			  </div>
			</div>
          ...
          <div class="col-lg-6" style="">
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				...
				<div class="form-group ">
                    <label for="id" class="control-label col-lg-2"><font color="blue">아이디</font></label>
                    <div class="col-lg-4">
                      <input class=" form-control" id="id" name="id" minlength="2" type="text" required 
					  <?if(isset($no)){echo 'value='.$result['emp_id'];}?>>
                    </div>
                    <label for="pass" class="control-label col-lg-2"><font color="blue">비밀번호</font></label>
                    <div class="col-lg-4">
                      <input class=" form-control" id="pass" name="pass" minlength="2" type="text" required 
					  <?if(isset($no)){echo 'value='.$result['emp_pass'];}?>>
                    </div>
				</div>
