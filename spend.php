<?
	...
	switch($sCase)
	{
		...
		//담당자
		case 3:
		$searchSql = ' where in_out_manager like "%' .$de_mana. '%" and de_sp_cate = "출금"';
		break;
		...
		// 날짜 + 담당자
		case 5:
		$searchSql = ' where de_sp_date >= "' .$date_from. '" and de_sp_date <= "' .$date_to. '" and in_out_manager like"%' .$de_mana. '%" and de_sp_cate = "출금"';
		break;

		// 거래처 + 담당자
		case 6:
		$searchSql = ' where com_name like "%' .$de_com. '%" and de_sp_cate = "출금" and in_out_manager like "%' .$de_mana. '%" and de_sp_cate = "출금"';
		break;

		// 날짜 + 거래처 + 담당자
		case 7:
		$searchSql = ' where de_sp_date >= "' .$date_from. '" and de_sp_date <= "' .$date_to. '" and com_name like "%' .$de_com. '%" and in_out_manager like "%' .$de_mana. '%" and de_sp_cate = "출금"';
		break;
	}
						...
						<section id="no-more-tables">
							<table class="table table-bordered table-hover table-striped">
								...
								<tr>
									...
									<td class="numeric" data-title="출금 날짜"><?echo $row['de_sp_date'];?></td>
