    ...
    <section id="main-content" style="min-height:800px;">
	  <section class="wrapper">
        <h3><a href="spendNew.php"><i class="fa fa-angle-right"></i>출금 추가</a></h3>
					<form action="./api/spendReg/spendInsert.php" class="form-horizontal style-form" method="post" name="depoform" id="depoform">
						<div class="row mt">
							<div class="col-lg-6">
						...
						<table class="table table-bordered table-hover table-striped" id="order_table">
						  ...
						  <tbody id="tbody">
								<tr>
									...
									<td data-title="상품코드"><input type="text" class="form-control" id="product_code[0]" name="product_code[0]" onclick="show_prod(this)" required="" value=""></td>
									<td data-title="상품명"><input type="text" class="form-control" id="product_name[0]" name="product_name[0]" onclick="show_prod(this)" required="" value=""></td>
  ...
  <?$layout->js($js);?>
	...
	<script>
		...
		$('#addItemBtn').click(function() {
			...
			rowItem += '<td data-title="상품코드"> <input type="text" class="form-control" id="product_code['+i+']" name="product_code['+i+']" onclick="show_prod(this)" value="" required=""></td>';
			rowItem += '<td data-title="상품명"> <input type="text" class="form-control" id="product_name['+i+']" name="product_name['+i+']" onclick="show_prod(this)" value="" required=""></td>';
