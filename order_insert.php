  ...
  <section id="container">
    ...
    <section id="main-content" style="min-height:1000px;">
	  ...
	  <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>주문 등록</h3>
    ...
    <!--content start-->
            ...
            <div class="form-panel">
			  <div class="cmxform form-horizontal style-form">
				...
				<div class="form-group ">
                    <label for="num" class="control-label col-lg-2"><font color="red">주문일자</font></label>
                    <div class="col-lg-10">
		...
		<h4><i class="fa fa-angle-right"></i>상세 정보</h4>
	     <form method="post" name="order_detailform">
				  ...
				  <section id="no-more-tables">
					<table class="table table-bordered table-hover table-striped"  id="order_table">
					  ...
					  <tbody id="tbody">
							...
							<td data-title="상품코드"><input type="text" class="form-control" id="product_code[0]"></td>
							<td data-title="상품명"><input type="text" class="form-control" id="product_name[0]"></td>
							<td data-title="총 수량"><input type="text" class="form-control" id="amout[0]"></td>
							<td data-title="공급가"><input type="text" class="form-control" id="supply_price[0]"></td>
							<td data-title="부가세">
								<select class="form-control" id="surtax[0]" style="font-size:13px;">
									<option value="aplly">적용</option>
									<option value="non_apply">미적용</option>
								</select>
							</td>
							<td data-title="할인"><input type="text" class="form-control" id="discount[0]"></td>
							<td data-title="총 가격"><input type="text" class="form-control" id="total_price[0]" readonly="readonly"></td>
					  </tbody>
					</table>
				  </section>
				<!--</div>-->
  ...
  ");?>
	...
	<script>
		...
		$('#addItemBtn').click(function() {
			...
			rowItem += '<td> <input type="text" class="form-control" name="product_code['+i+']" onclick="show_prod(this)" required=""></td>';
			rowItem += '<td> <input type="text" class="form-control" name="product_name['+i+']" onclick="show_prod(this)" required=""></td>';
			rowItem += '<td> <input type="text" class="form-control" name="supply_price['+i+']" required=""></td>';
			rowItem += '<td> <input type="text" class="form-control" name="amount['+i+']" required=""></td>';
			...
			rowItem += '<td> <input type="text" class="form-control" name="discount['+i+']" value="0" required=""></td>';
			rowItem += '<td> <input type="text" class="form-control" name="total_price['+i+']" readonly="readonly" required=""></td>';
